  ...
  return (
    <SafeAreaView style={styles.screen}>
      <View style={styles.loginHero}>
        ...
        <Text style={styles.heroTitle}>Tu control de combustible, al día.</Text>
      ...
      <View style={styles.authPanel}>
        ...
        <Text style={styles.panelSubtitle}>Inicia sesión o crea una cuenta local.</Text>
        ...
        <AppButton title="Iniciar sesión" onPress={onLogin} />
